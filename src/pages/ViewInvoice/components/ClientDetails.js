    ...
    <div className="grid grid-cols-2 items-start">
            <div className="flex flex-col gap-4">
                <div className="">
                    ...
                    <h2 className='text-h2 font-bold'>{createdAt}</h2>
                </div>
                <div className="">
                    <span className="text-body-m">Due Date</span>
                    <h2 className='text-h2 font-bold'>{dueDate}</h2>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4 items-start">
                <div className="">
                    ...
                    <h2 className='text-h2 font-bold'>{invoice.client_name}</h2>
                </div>
            ...
            <div className="">
                ...
                <h4 className='text-h4 font-bold'>{invoice.client_email}</h4>
            </div>
        </div>
  )
}
