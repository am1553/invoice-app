...
function Logo() {
  ...
  return (
    <div className='relative max-md:w-[72px] max-md:h-[72px] md:w-[100px] md:h-[100px] bg-main-purple flex items-center justify-center rounded-r-[20px] overflow-hidden' onClick={() => navigate('/')}>
