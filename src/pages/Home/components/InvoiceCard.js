...
function InvoiceCard({data}) {
  ...
  return (
    <div className={`mx-4 cursor-pointer ${theme === "light" ? "bg-white" : "bg-dark-greyish-blue"} rounded-md p-4 flex flex-col gap-4 sm:grid sm:grid-cols-2 sm:items-center`} onClick={() => navigate(`/invoice/${data.id}`)}>
